...
const produktyCols: ColumnDef<Produkt>[] = [
  ...
  { key: "nazwa_pl", label: "Nazwa" },
  { key: "grupa_pl", label: "Grupa" },
...
const opakowaniaCols: ColumnDef<Opakowanie>[] = [
  ...
  { key: "typ_opakowania_pl", label: "Typ" },
  { key: "wariant_opakowania_pl", label: "Wariant" },
  { key: "material_tary", label: "Materiał" },
...
const standardyCols: ColumnDef<StandardPalety>[] = [
  ...
  { key: "nazwa_produktu_pl", label: "Produkt" },
  { key: "wariant_opakowania_pl", label: "Opakowanie" },
